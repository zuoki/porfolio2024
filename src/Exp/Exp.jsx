...
const Exp = () => {
    return (
        <section className=' z-10 '>
            ...
            <section className='text-white font-semibold font-sans border-solid border-t-2 border-l-2 p-2 pt-4 pb-4 border-white m-4 mt-4 rounded-lg bg-gray-950 bg-opacity-45 blur-[.2px]  sm:w-[65vw] xl:w-[50vw] 2xl:w-[35vw]'>
