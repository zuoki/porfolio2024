        ...
        <section id='perico' className=' flex justify-center .agrandar '>
            ...
            <div className='pt-6 pb-4 '>
                ...
                <div className='grid grid-cols-4 text-white font-semibold font-sans border-solid  border-t-2 border-l-2 p-2 border-white  m-4  pt-4 pb-4 rounded-lg bg-gray-950 bg-opacity-45 gap-4 '>
                    ...
                    <span class="icono ml-4 mt-3"><RiJavascriptFill color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiTailwindcss color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><BiLogoPostgresql color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiVite color="white" size="30px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><FaNode color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><FaGitSquare color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiPrisma color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><FaFigma color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiAstro color="white" size="35px" class=" mt-2 sm:scale-125" />
                    </span><span class="icono ml-4 mt-3"><SiPostman color="white" size="35px" class="  mt-2  sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiRedux color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><SiExpress color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><FaHtml5 color="white" size="35px" class="  mt-2 sm:scale-125" />
                    </span>
                    <span class="icono ml-4 mt-3"><FaCss3 color="white" size="35px" class=" mt-2 mb-4 sm:scale-125" />
                    </span>
                </div>
