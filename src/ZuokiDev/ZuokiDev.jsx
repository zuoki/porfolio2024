...
<div className='text-white font-semibold font-sans border-solid border-t-2 border-l-2 p-2 pt-4 pb-4 border-white m-4 mt-4 rounded-lg bg-gray-950 bg-opacity-45  sm:w-[65vw] xl:w-[88vw] 2xl:w-[45vw] sm:p-[5vw] xl:p-[3vw] 2xl:p-[1vw]'>
