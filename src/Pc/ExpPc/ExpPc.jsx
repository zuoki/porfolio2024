...
const ExpPc = () => {
    return (
        <section id="mi-div3"  className='flex justify-center '>
            <article  className='hover:scale-105 transition hover:bg-opacity-70 text-white font-semibold font-sans border-solid  border-t-2 border-l-2 p-2 border-white  m-4  pt-4 pb-4 rounded-lg bg-gray-950 bg-opacity-45   w-[45vw] h-[50vh] 2xl:h-[33vh] 2xl:w-[38vw]  mb-14   '>
                ...
                <div className='w-[35vw]  flex items-center 2xl:w-[35vw] 2xl:h-[23vh] mx-auto'>
                    <p className='mt-6' >
            ...
            <article className='hover:scale-105 transition hover:bg-opacity-70 text-white font-semibold font-sans border-solid  border-t-2 border-l-2 p-2 border-white  m-4  pt-4 pb-4 rounded-lg bg-gray-950 bg-opacity-45   w-[45vw] h-[50vh] 2xl:h-[33vh] 2xl:w-[38vw]  '>
