...
const NavBar = () => {
    return (
        ...
        <div className='flex justify-center'>
            ...
            <div className='w-11/12 h-8 bg-gradient-to-tr from-red-600 to-orange-400 rounded-3xl fixed mx-auto flex  justify-around text-white font-semibold font-sans bottom-6 '>
